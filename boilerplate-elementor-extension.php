...
final class Boilerplate_Elementor_Extension {
	...
	public function i18n() {
		...
		load_plugin_textdomain( 'layerdrops' );
    ...
    public function widget_styles() {
        ...
        wp_enqueue_style( 'qrowd', plugins_url( 'assets/css/qrowd.css', __FILE__ ) );
        wp_enqueue_style( 'bootstrap', plugins_url( 'assets/css/bootstrap.min.css', __FILE__ ) );
        wp_enqueue_style( 'odometer', plugins_url( 'assets/css/odometer.min.css', __FILE__ ) );
		wp_enqueue_style( 'qrowd-responsive', plugins_url( 'assets/css/qrowd-responsive.css', __FILE__ ) );
		wp_enqueue_style( 'Hello World', plugins_url( 'assets/css/hello-world.css', __FILE__ ) );
    }
	...
	public function init_widgets() {
		...
		// Register widget
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Dayerdrops_Widget() );
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'layerdrops' ),
			'<strong>' . esc_html__( 'Elementor Test Extension', 'layerdrops' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'layerdrops' ) . '</strong>'
		);
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'layerdrops' ),
			'<strong>' . esc_html__( 'Elementor Test Extension', 'layerdrops' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'layerdrops' ) . '</strong>',
	...
	public function admin_notice_minimum_php_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'layerdrops' ),
			'<strong>' . esc_html__( 'Elementor Test Extension', 'layerdrops' ) . '</strong>',
			'<strong>' . esc_html__( 'PHP', 'layerdrops' ) . '</strong>',
